...
about:
  ...
  links:
    - icon: github
      text: Github
      href: https://github.com/rmcd-mscb
    - text: "{{< ai google-scholar >}} Google Scholar"
      url: https://scholar.google.com/citations?user=ty8nKBgAAAAJ&hl=en
    - text: "{{< ai orcid >}} ORCID 0000-0002-0703-0638"
      url: https://orcid.org/0000-0002-0703-0638
    - text: "{{< ai usgs >}} U.S. Geolocial Survey"
      url: https://www.usgs.gov/staff-profiles/richard-mcdonald
---
## BIO
Hi!  I'm an earth scientist that works on applications of geomorphology and hydrology.  I've worked on problems ranging from aeolian and fluvial sediment-transport, riverine hydraulics, analysis of aquatic physical habitat, lagrangian particle-tracking applications of riverine larval drift and general dispersion, watershed modeling, and open-source gis workflows and web-services.  I'm aslo a software developer with experience in C, C++, FORTRAN, and Python.
...
### Python Packages
* [GDPTools](https://gdptools.readthedocs.io/en/latest/): A python package for spatial interpolations from gridded datasets to arbitrary polygons using area-weighted statistics.
